...
//NO３．データ登録SQL作成
    ...
    // ここのinsertで変数を直接入れるのはダメ、バインド変数を入れると、危険な文字を無効化できる
        $stmt = $pdo->prepare("INSERT INTO kakuzukeDB_an_table(name,address,userid,FY2017uriage,FY2017urisou,FY2017eiri,FY2017keitune,FY2017zyunnri,FY2017sousisan,FY2017ryudousisan,FY2017koteisisan,FY2017ryudouhusai,FY2017koteihusai,FY2017zyunnsisan,FY2018uriage,FY2018urisou,FY2018eiri,FY2018keitune,FY2018zyunnri,FY2018sousisan,FY2018ryudousisan,FY2018koteisisan,FY2018ryudouhusai,FY2018koteihusai,FY2018zyunnsisan,FY2019uriage,FY2019urisou,FY2019eiri,FY2019keitune,FY2019zyunnri,FY2019sousisan,FY2019ryudousisan,FY2019koteisisan,FY2019ryudouhusai,FY2019koteihusai,FY2019zyunnsisan,comment,indate,tani)VALUES(:name,:address,:userid,:FY2017uriage,:FY2017urisou,:FY2017eiri,:FY2017keitune,:FY2017zyunnri,:FY2017sousisan,:FY2017ryudousisan,:FY2017koteisisan,:FY2017ryudouhusai,:FY2017koteihusai,:FY2017zyunnsisan,:FY2018uriage,:FY2018urisou,:FY2018eiri,:FY2018keitune,:FY2018zyunnri,:FY2018sousisan,:FY2018ryudousisan,:FY2018koteisisan,:FY2018ryudouhusai,:FY2018koteihusai,:FY2018zyunnsisan,:FY2019uriage,:FY2019urisou,:FY2019eiri,:FY2019keitune,:FY2019zyunnri,:FY2019sousisan,:FY2019ryudousisan,:FY2019koteisisan,:FY2019ryudouhusai,:FY2019koteihusai,:FY2019zyunnsisan,:comment,sysdate(),:tani);");
...
//NO４．データ登録処理後
    if($status==false){
        ...
        exit("SQLへのデータ登録失敗(insert.phpのNO3の操作)".$error[2]);
    }else{
        redirect("index.php");
    }
